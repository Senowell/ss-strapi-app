...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    leadership: Schema.Attribute.Component<'about.team-member', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Solutions: Schema.Attribute.Component<'about.solution-block', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Company news and blog posts';
    displayName: 'Blog';
    pluralName: 'blogs';
    singularName: 'blog';
  };
...
export interface ApiContactSubmissionContactSubmission
  ...
  info: {
    description: 'Form submissions from the Contact Us page';
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Copy_Right_Info: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Menu: Schema.Attribute.Component<'menu-section.mega-menu', true>;
    publishedAt: Schema.Attribute.DateTime;
    QuickLinks: Schema.Attribute.Component<'navigation.link', true>;
    SiteName: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    associatedProducts: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    DownloadsSection: Schema.Attribute.Component<
      'downloads.download-items',
      true
    >;
    faqs: Schema.Attribute.Relation<'manyToMany', 'api::faq.faq'>;
    FeaturedImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    FeaturedService: Schema.Attribute.Boolean;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ServiceApplication: Schema.Attribute.Component<
